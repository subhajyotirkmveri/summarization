        ...
        if uploaded_file:
            ...
            if st.button("Summarize Document"):
                ...
                with col2:
                    ...
                    summary = generate_gemini_content(input_text, text_prompt)
        ...
        with col2:
            if wiki_URL:
                if st.button("Summarize"):
                    summary = generate_gemini_content(wiki_text(wiki_URL), text_prompt)
                    st.success(summary)
        ...
        if input_text is not None:
            if st.button("Summarize Text"):
                ...
                with col2:
                    ...
                    result = generate_gemini_content(input_text, text_prompt)
                    st.success(result)
